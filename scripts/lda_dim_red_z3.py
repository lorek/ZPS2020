#
# LDA_dim_reduction.py
#
# z katalogu --input-dir
# trzy pliki: train_data.pkl, test_data.pkl, class_names.pkl
#
# Wylicza macierz LDA na punktach train_data.pkl i je przeksztalca
...
print("LDA reduction ", x_train.shape[1], " -> ", n_comp,  " ...",  end =" ")
...
lda_object_file = open(output_dir+"/lda_object.pkl","wb")
pickle.dump(lda,lda_object_file)