...
print("KPCA reduction ", x_train.shape[1], " -> ", n_comp, " ...", end=" ")

kpca = decomposition.KernelPCA(n_components=n_comp, kernel = 'poly' )
...
kpca_object_file = open(output_dir + "/kpca_object.pkl", "wb")
pickle.dump(kpca, kpca_object_file)
