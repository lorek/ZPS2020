...
# Example:
# python scripts/z5_prepare_data_glass.py --input-dir datasets/glass --output-dir datasets_prepared/glass
...
# wczytaj plik data
df = pd.read_table(input_dir+"/glass.data", sep=",")
...
# kolumny od 2 do 10 to dane:

data = data_all[:,:-1] # = wszystkie wiersze, kolumny od 1 do przedostatniej (pierwsza to id).
