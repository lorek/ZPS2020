...
Example:
    $ python scripts/z1_prepare_data_tae_target.py --input-dir datasets_prepared/teaching_assistant_evaluation \
        --output-dir datasets_prepared/teaching_assistant_evaluation_target
"""
