#
# nmf_dim_reduction.py
#
# z katalogu --input-dir
# trzy pliki: train_data.pkl, test_data.pkl, class_names.pkl
#
# Wylicza macierze NMF na punktach train_data.pkl i je przeksztalca
...
print("NMF reduction ", x_train.shape[1], " -> ", n_comp,  " ...",  end =" ")

nmf = NMF(n_components = n_comp, max_iter=10000, init='random')

## wyuczenie macierzy tranformacji i zaaplikowanie jej na x_train
start_time = time.time()
x_train_reduced =  nmf.fit_transform(x_train, y_train)
...
# dodatkowo zapisujemy sam obiekt LDA

nmf_object_file = open(output_dir+"/nmf_object.pkl","wb")
pickle.dump(nmf,nmf_object_file)