...
def ParseArguments():
    ...
    parser.add_argument('--solver', default="svd", required=False, help='solver: svd/lsqr/eigen (default: %(default)s)')
    args = parser.parse_args()

    return args.input_dir, args.solver
        
input_dir, solv = ParseArguments()
...
print("lda: accuracy = ", metric_accuracy)
