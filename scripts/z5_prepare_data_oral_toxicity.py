...
# Example:
#  python scripts/z5_prepare_data_oral_toxicity.py --input-dir datasets/oral_toxicity --output-dir datasets_prepared/oral_toxicity
...
# wczytaj plik data
df = pd.read_table(input_dir + "/oral_toxicity.data", sep=";")
